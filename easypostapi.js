...
module.exports = function(apiKey, options) {
    ...
    easypost.Resource.prototype.refresh = function(params, cb) {
        ...
        return requestor.request('get', url, args.params, args.cb);
    }
    easypost.Resource.create = function(cls, params, cb) {
        ...
        return requestor.request('post', url, params, cb);
    };
    easypost.Resource.retrieve = function(cls, params, cb) {
        ...
        return requestor.request('get', url, params, cb);
    };
    ...
    easypost.Address.create = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.create('address', args.params, args.cb);
    }
    easypost.Address.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('address', args.params, args.cb);
    }
    easypost.Address.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.all('address', args.params, args.cb);
    }
    ...
    easypost.Address.create_and_verify = function(params, cb) {
        ...
        return requestor.request('post', url, args.params, args.cb);
    }
    ...
    easypost.Parcel.create = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.create('parcel', args.params, args.cb);
    }
    easypost.Parcel.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.retrieve('parcel', args.params, args.cb);
    }
    easypost.Parcel.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.all('parcel', args.params, args.cb);
    }
    ...
    easypost.CustomsItem.create = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.create('customs_item', args.params, args.cb);
    }
    easypost.CustomsItem.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.retrieve('customs_item', args.params, args.cb);
    }
    easypost.CustomsItem.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.all('customs_item', args.params, args.cb);
    }
    ...
    easypost.CustomsInfo.create = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.create('customs_info', args.params, args.cb);
    }
    easypost.CustomsInfo.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.retrieve('customs_info', args.params, args.cb);
    }
    easypost.CustomsInfo.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        easypost.Resource.all('customs_info', args.params, args.cb);
    }
    ...
    easypost.Shipment.create = function(params, cb) {
        ...
        return easypost.Resource.create('shipment', args.params, args.cb);
    }
    easypost.Shipment.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('shipment', args.params, args.cb);
    }
    easypost.Shipment.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.all('shipment', args.params, args.cb);
    }
    ...
    easypost.Shipment.prototype.buy = function(params, cb) {
        ...
        var requestor = new Requestor(this.apiKey);
        return requestor.request('post', url, args.params, args.cb, this);
    }
    ...
    easypost.Rate = function(apiKey) {
        return easypost.Resource.call(this, 'rate', apiKey);
    }
    easypost.Rate.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('rate', args.params, args.cb);
    }
    ...
    easypost.Refund = function(apiKey) {
        return easypost.Resource.call(this, 'refund', apiKey);
    }
    easypost.Refund.create = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.create('refund', args.params, args.cb);
    }
    easypost.Refund.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('refund', args.params, args.cb);
    }
    easypost.Refund.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.all('refund', args.params, args.cb);
    }
    ...
    easypost.Batch = function(apiKey) {
        return easypost.Resource.call(this, 'batch', apiKey);
    }
    easypost.Batch.create = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.create('batch', args.params, args.cb);
    }
    easypost.Batch.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('batch', args.params, args.cb);
    }
    easypost.Batch.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.all('batch', args.params, args.cb);
    }
    ...
    easypost.ScanForm = function(apiKey) {
        return easypost.Resource.call(this, 'scan_form', apiKey);
    }
    easypost.ScanForm.create = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.create('scan_form', args.params, args.cb);
    }
    easypost.ScanForm.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('scan_form', args.params, args.cb);
    }
    easypost.ScanForm.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.all('scan_form', args.params, args.cb);
    }
    ...
    easypost.PostageLabel = function(apiKey) {
        return easypost.Resource.call(this, 'postage_label', apiKey);
    }
    easypost.PostageLabel.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('postage_label', args.params, args.cb);
    }
    easypost.PostageLabel.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.all('postage_label', args.params, args.cb);
    }
    ...
    easypost.Tracker = function(apiKey) {
        return easypost.Resource.call(this, 'tracker', apiKey);
    }
    easypost.Tracker.create = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.create('tracker', args.params, args.cb);
    }
    easypost.Tracker.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('tracker', args.params, args.cb);
    }
    easypost.Tracker.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.all('tracker', args.params, args.cb);
    }
    ...
    easypost.Event = function(apiKey) {
        return easypost.Resource.call(this, 'event', apiKey);
    }
    ...
    easypost.Event.retrieve = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.retrieve('event', args.params, args.cb);
    }
    easypost.Event.all = function(params, cb) {
        var args = normalizeArgs(arguments);
        return easypost.Resource.all('event', args.params, args.cb);
    }
